...
1. Read `CODEX.md`, `AGENTS.md`, architecture docs, and the current code before proposing changes.
2. Identify constraints, risks, and irreversible choices.
3. Produce a concrete technical direction with clear implementation boundaries.
